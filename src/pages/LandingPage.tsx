        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <div className="flex-shrink-0">
              <h1 className="text-2xl font-bold text-blue-600">LocalHub</h1>
            </div>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Booking Management</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Easily manage appointments and bookings with an intuitive calendar interface.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Keep track of your customers and their preferences in one place.
                </p>
              </div>
